...
const generateAccessAndRefereshToken = async(userId) =>
{
    try {
        ...
        throw new ApiError(500, "Something went wrong whle generating refresh & access token")
    }
}
...
const logoutUser = asyncHandler(async(req, res) => {
    await User.findByIdAndUpdate(
        ...
        {
            new: true //return response will be new
        }
    )
...
const getUserChannelProfile = asyncHandler(async(req,res) => {
    ...
    const channel = await User.aggregate([
        ...
        {
            //count no. of subscribers through channels
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        {
            //how many you have subscribed through subscriber
            $lookup: {
                from: "subscriptions",
                localField: "_id",
        ...
        {
            // added fields to original user object
            $addFields: {
                subscribersCount: {
                    $size: "$subscribers"
                },
